...
public class DashboardPage extends BasePage {
    ...
    public WebElement getAdministrationButton() { return driver.findElement(administrationButtonLocator); }
    public WebElement getDeleteButton() { return driver.findElement(deleteButtonLocator); }
    public WebElement getProjectButton() { return driver.findElement(projectButtonLocator); }
    public WebElement getConfirmDeleteProjectCheckBox() { return driver.findElement(confirmDeleteProjectCheckBoxLocator); }
    public WebElement getConfirmDeleteProjectButton() { return driver.findElement(confirmDeleteProjectButtonLocator); }
    public WebElement getAddTestSuiteButton() { return driver.findElement(addTestSuiteButtonLocator); }
    public WebElement getPopUpMessage() { return driver.findElement(popUpMessageLocator); }
    ...
    public void clickAdministrationButton() { getAdministrationButton().click(); }
